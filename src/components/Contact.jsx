  ...
  return (
    <>
      <section ref={ref} className="px-6 py-10 flex flex-col gap-10 md:flex-row lg:flex-row md:justify-between lg:justify-between">
        <div className="flex flex-col gap-5 items-start md:w-4/12 lg:w-4/12" data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
        ...
        <div className="md:w-4/12 lg:w-4/12 space-y-5" data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
        ...
        <div className="space-y-5 md:w-4/12 lg:w-4/12" data-aos="fade-up" data-aos-easing="ease-out-cubic" data-aos-duration="2000">
